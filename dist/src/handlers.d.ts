 ...
 */
export declare function handleAction<T extends (...args: any[]) => any | undefined | null>(action: T, ...args: any[]): ReturnType<T> | undefined;
/**
 *
 * A handler function used to handle all the
 * calls made to native code. The purpose is
...
export declare function handlePromise<T extends (...args: any[]) => any | undefined | null>(action: T, ...args: any[]): Promise<ReturnType<T> | undefined>;
